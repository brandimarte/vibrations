...
#          ${4} :  I-SMEAGOL executable with path                       #
#                                                                       #
#  Use: ./runFCOS.grid.sh [FC calculation directory] [FC input file]    #
#       [parallel run command] [I-SMEAGOL executable]                   #
#                                                                       #
...
then
    ...
    echo -e "vibrations: Use: ./runFCOS.grid.sh"                        \
...
then
    echo -e "\nvibrations: ERROR: you don't have permission to execute" \
	"\"${4}\"!\n"
    exit -1
else
    echo -e "ok!\n"
