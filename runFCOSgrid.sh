...
#    ${2} :  SIESTA executable with path                  #
#    ${3} :  FC calculation directory                     #
#  *****************************************************  #
...
echo -e "\nvibranal: Including the option 'FCwriteHS .true.' at 'pbFCrun.fdf' file.\n"
...
echo -e "vibranal: Including the option 'FConlyS .false.' at 'pbFCrun.fdf' file.\n"
...
echo -e "\nvibranal: Including the option 'FCwriteHS .false.' at 'pbFCrun.fdf' file.\n"
check=`grep -i "FCWRITEHS" ${FCfdf}`
sed "s/${check}/FCwriteHS            .false.\n/I" -i ${FCfdf}

# Sets FC 'fdf' input file with the flag 'FConlyS .true.'.
echo -e "vibranal: Including the option 'FConlyS .true.' at 'pbFCrun.fdf' file.\n"
check=`grep -i "FCONLYS" ${FCfdf}`
